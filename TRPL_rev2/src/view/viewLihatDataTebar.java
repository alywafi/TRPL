 ...
 * @author acer
 */
public class viewLihatDataTebar extends javax.swing.JFrame {

    /**
     * Creates new form view_peminjaman
     */
    public viewLihatDataTebar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewLihatDataTebar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewLihatDataTebar().setVisible(true);
            }
        });
    }
