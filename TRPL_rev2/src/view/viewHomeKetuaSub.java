 ...
 * @author acer
 */
public class viewHomeKetuaSub extends javax.swing.JFrame {

    /**
     * Creates new form viewuser
     */
    public viewHomeKetuaSub() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(klikRamalan, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 270, 240, 260));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewHomeKetuaSub.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewHomeKetuaSub().setVisible(true);
            }
        });
    }
