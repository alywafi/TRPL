 ...
 * @author acer
 */
public class viewPeminjamanInventaris extends javax.swing.JFrame {

    /**
     * Creates new form view_peminjaman
     */
    public viewPeminjamanInventaris() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnverifikasi, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 140, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewPeminjamanInventaris.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewPeminjamanInventaris().setVisible(true);
            }
        });
    }
