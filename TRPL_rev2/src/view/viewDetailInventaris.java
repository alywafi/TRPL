 ...
 * @author acer
 */
public class viewDetailInventaris extends javax.swing.JFrame {

    /**
     * Creates new form view_peminjaman
     */
    public viewDetailInventaris() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btntambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewDetailInventaris.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewDetailInventaris().setVisible(true);
            }
        });
    }
