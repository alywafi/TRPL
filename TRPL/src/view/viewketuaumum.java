 ...
 * @author acer
 */
public class viewketuaumum extends javax.swing.JFrame {

    /**
     * Creates new form viewketuaumum
     */
    public viewketuaumum() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ketuaumum");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(763, 364, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewketuaumum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewketuaumum().setVisible(true);
            }
        });
    }
