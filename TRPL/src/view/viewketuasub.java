 ...
 * @author acer
 */
public class viewketuasub extends javax.swing.JFrame {

    /**
     * Creates new form viewketuasub
     */
    public viewketuasub() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ketuasub");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(688, 321, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewketuasub.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewketuasub().setVisible(true);
            }
        });
    }
