...
public class CPeramalan {
    ...
    public CPeramalan(viewPeramalan view1, viewHasilPeramalan View2, MPeramalan Model, String Username) throws SQLException {
        ...
        view2.klikminimize(new minimizeaction2());
...
//pakan
        ...
        row2[0] = "Jenis Pakan";
        row2[1] = "Pellet pf800";
        row2[2] = "Pellet pf 1000";
        row2[3] = "Pellet pelet 781-1";
        row2[4] = "Pellet pelet 781-2";
        table2.addRow(row2);
...
//Vitamin
        row2[0] = "Vitamin";
        row2[1] = "metilen blue /ganti air";
        row2[2] = "metilen blue /ganti air";
        row2[3] = "metilen blue /ganti air";
        row2[4] = "-";
        table2.addRow(row2);
//frekuensi ganti air
...
//Biaya
    ...
    private class minimizeaction2 implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            view2.setState(Frame.ICONIFIED);
        }
    ...
    private String GetBulanTanggal(int bulan) {
        ...
        int bln = now.get(Calendar.MONTH) + bulan + 1;
        ...
        String valid = String.valueOf(now.get(Calendar.DATE)) + " - " + String.valueOf(bln) + " - " + String.valueOf(tahun);
        return valid;
    }
}
